...
export default class Client {
    ...
    public readonly blob: blob.ServiceClient
    ...
    public readonly urlshortener: urlshortener.ServiceClient
    ...
    constructor(target: string | BaseURL = "prod", options?: string | ClientOptions) {
        ...
        this.blob = new blob.ServiceClient(base)
        ...
        this.urlshortener = new urlshortener.ServiceClient(base)
...
export namespace blob {
    ...
    export class ServiceClient {
         ...
         * Serve File
         */
        public async ServeFile(method: "GET", key: string, body?: BodyInit, options?: CallParameters): Promise<Response> {
            return this.baseClient.callAPI(method, `/blob/${encodeURIComponent(key)}`, body, options)
        }

        /**
         * Uploads a file
         */
        public async UploadFile(method: "POST", body?: BodyInit, options?: CallParameters): Promise<Response> {
            return this.baseClient.callAPI(method, `/blob/upload`, body, options)
        }
    }
}
...
export namespace permissions {
    ...
    export class ServiceClient {
         ...
         */
        public async CheckPermission(params: dto.BatchRelationCheckRequest): Promise<dto.BatchRelationCheckResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/permissions/check`, JSON.stringify(params))
            return await resp.json() as dto.BatchRelationCheckResponse
        }

        /**
         * List Objects with valid relations
         */
        public async ListRelations(params: dto.ListRelationsRequest): Promise<dto.ListRelationsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/permissions/related`, JSON.stringify(params))
            return await resp.json() as dto.ListRelationsResponse
        }
    }
}
...
export namespace tenants {
    ...
    export class ServiceClient {
         ...
         */
        public async FindMember(tenant: number, user: number): Promise<dto.TenantMembership> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/tenants/members/${encodeURIComponent(tenant)}/${encodeURIComponent(user)}`)
            return await resp.json() as dto.TenantMembership
        }
         ...
         */
        public async InviteNewMember(tenant: number, params: dto.CreateTenantInviteRequest): Promise<void> {
            await this.baseClient.callAPI("POST", `/tenants/invites/${encodeURIComponent(tenant)}`, JSON.stringify(params))
        }
         ...
         */
        public async LookupTenantMembers(tenant: number): Promise<dto.LookupTenantMembersResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/tenants/members/${encodeURIComponent(tenant)}`)
            return await resp.json() as dto.LookupTenantMembersResponse
        }

        /**
         * Checks whether a tenant name exists or not
         */
        public async NameAvailable(params: dto.TenantNameAvailableRequest): Promise<dto.TenantNameAvailableResponse> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                name: params.Name,
            })
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/tenants/name-available`, undefined, {query})
            return await resp.json() as dto.TenantNameAvailableResponse
        }

        /**
         * Creates a new Tenant
         */
        public async NewTenant(params: dto.NewTenantRequest): Promise<dto.NewTenantResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/tenants`, JSON.stringify(params))
            return await resp.json() as dto.NewTenantResponse
        }
    }
}
...
export namespace urlshortener {
    ...
    export class ServiceClient {
         ...
         * Shortened URLs
         */
        public async AccessShortenedUrl(method: "GET", key: string, body?: BodyInit, options?: CallParameters): Promise<Response> {
            return this.baseClient.callAPI(method, `/short/${encodeURIComponent(key)}`, body, options)
        }
    }
}
...
export namespace dto {
    ...
    export interface BatchRelationCheckRequest {
        checks: RelationCheck[]
    }

    export interface BatchRelationCheckResponse {
    ...
    export interface LookupTenantMembersResponse {
        /**
         * The tenant memberships
         */
        members: TenantMembershipLookup[]
    }
    ...
    export interface TenantNameAvailableResponse {
        available: boolean
    }
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "scholaris-xnz2-Generated-TS-Client (Encore/v1.45.2)";
        }
