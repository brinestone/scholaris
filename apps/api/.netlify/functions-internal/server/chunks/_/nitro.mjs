...
const _lazy_2U3dK_ = () => import('../routes/index.mjs');

const handlers = [
  { route: '/', handler: _lazy_2U3dK_, lazy: true, middleware: false, method: undefined }
];
...
export { defineEventHandler as d, getRouteRulesForPath as g, joinHeaders as j, normalizeCookieHeader as n, useNitroApp as u };
